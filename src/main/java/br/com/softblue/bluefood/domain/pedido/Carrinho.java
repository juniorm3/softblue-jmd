...
public class Carrinho {
	...
	public void adiconarItem(ItemCardapio itemCardapio, Integer quantidade, String observacoes)
	...
	public void adiconarItem(ItemPedido itemPedido) {
		try {
			adiconarItem(itemPedido.getItemCardapio(), itemPedido.getQuantidade(), itemPedido.getObservacoes());
